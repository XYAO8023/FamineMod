...
function GenerateSpicedFoods(foods)
    for foodname, fooddata in pairs(foods) do
        for spicenameupper, spicedata in pairs(SPICES) do
            ...
            newdata.cookbook_category =
                fooddata.cookbook_category ~= nil and ("spiced_" .. fooddata.cookbook_category) or nil
...
-- #TODO: add DS Exclusive dishes
GenerateSpicedFoods(require("preparedfoods"))
-- GenerateSpicedFoods(require("preparedfoods_warly"))--deleted temporary
