...
TEMPLATES = {
    ...
    InvisibleButton = function(width, height, onclick, onfocus)
    	local btn = ImageButton("images/dstui.xml", "blank.tex", "blank.tex", "blank.tex", "blank.tex", "blank.tex", {width,height}, {0,0})
	...
	ModListItem = function (modname, modinfo, modstatus, isenabled)
		...
		opt.white_bg = opt:AddChild(Image("images/dstui.xml", "single_option_bg_large.tex"))
		opt.white_bg:SetScale(.63, .9)

        opt.state_bg = opt:AddChild(Image("images/dstui.xml", "single_option_bg_large_gold.tex"))
        opt.state_bg:SetScale(.63, .9)
        opt.state_bg:Hide()

		opt.checkbox = opt:AddChild(ImageButton("images/dstui.xml", "checkbox_off.tex", "checkbox_off_highlight.tex", "checkbox_off_disabled.tex", nil, nil, {1,1}, {0,0}))
		opt.checkbox:SetPosition(140, -22, 0)

		opt.image = opt:AddChild(Image("images/dstui.xml", "portrait_bg.tex"))
		...
		if isenabled then
			...
			opt.checkbox:SetTextures("images/dstui.xml", "checkbox_on.tex", "checkbox_on_highlight.tex", "checkbox_on_disabled.tex", nil, nil, {1,1}, {0,0})
		else
			opt.image:SetTint(1.0,0.5,0.5,1)
			opt.checkbox:SetTextures("images/dstui.xml", "checkbox_off.tex", "checkbox_off_highlight.tex", "checkbox_off_disabled.tex", nil, nil, {1,1}, {0,0})
		end
	...
	ModDLListItem = function (modname)
		...
		opt.white_bg = opt:AddChild(Image("images/dstui.xml", "single_option_bg.tex"))
    ...
    LabelButton = function(labeltext, buttontext, width_label, width_button, height, spacing, font, font_size, horiz_offset)
        ...
        wdg.label:SetHAlign( ANCHOR_RIGHT )
        wdg.label:SetColour(0,0,0,1)
        wdg.button = wdg:AddChild(ImageButton("images/dstui.xml", "in-window_button_sm_idle.tex", "in-window_button_sm_hl.tex", "in-window_button_sm_disabled.tex", "in-window_button_sm_hl_noshadow.tex", "in-window_button_sm_disabled.tex", {1, 1}, {0, 0}))
    ...
    ItemImageText = function(type, name, iconScale, font, textsize, string, colour, textwidth, image_offset)
        ...
        widg.check = widg.icon:AddChild(Image("images/dstui.xml", "checkmark.tex"))
